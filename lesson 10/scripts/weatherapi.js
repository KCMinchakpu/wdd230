...
const url = 'https://api.openweathermap.org/data/2.5/weather?q=AbujaNigeria&units=imperial&appid=51537de831b6bf7110e51babc5e1398f'
...
/*display the temp obtained, the icon and the description*/
  function  displayResults(weatherData) {
    ...
    currentTemp.innerHTML = `The current temperature in Abuja, Nigeria is <strong>${tF}F</strong>`;
